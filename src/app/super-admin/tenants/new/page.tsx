    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
        <Link href="/super-admin/tenants" style={{
          ...
          background: 'rgba(255,255,255,0.05)', color: '#a1a1aa', textDecoration: 'none',
        }}>
          <ArrowLeft size={18} />
        </Link>
        <div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            <div>
              ...
              <input
                ...
                placeholder="Importadora Sur S.A."
                value={form.name}
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: '15px', fontWeight: 600, color: '#fafafa', marginBottom: '4px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
          <Link href="/super-admin/tenants" style={{
            ...
            color: '#a1a1aa', borderRadius: '8px', textDecoration: 'none',
